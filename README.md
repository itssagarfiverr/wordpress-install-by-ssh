...
```ruby
cd /root && curl -o /root/wp_install.sh https://raw.githubusercontent.com/itssagarfiverr/One-Click-WordPress-Installation-on-Ubuntu-OS-by-SSH/main/wp_install.sh && chmod +x wp_install.sh && ./wp_install.sh && rm -rf wp_install.sh
```
...
[![WordPress URL](https://i.ibb.co/GQLYj1k1/image.png)](https://github.com/itssagarfiverr/wordpress-install-by-ssh)
